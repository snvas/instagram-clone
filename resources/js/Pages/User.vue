    ...
    <MainLayout>
                ...
                <div class="ml-6 w-full">
                    ...
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            ...
                            <div class="mr-6">
                                <span class="font-extrabold">124</span>
                                followers
                            </div>
                            <div class="mr-6">
                                <span class="font-extrabold">424</span>
                                following
                            </div>
                        </div>
                    </div>
        ...
        <div class="md:hidden">
            ...
            >
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">424</div>
                    <div class="text-gray-400 font-semibold -mt-1.5">
                        following
                    </div>
                </div>
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-0 md:pl-[90px]">
            <div class="md:block hidden mt-10 border-t border-t-gray-300">
                ...
                >
                    <div
                        class="p-[17px] w-1/4 flex justify-center items-center border-t bordet-t-gray-900"
                    >
                        <Grid
                            :size="15"
                            fillColor="#000"
