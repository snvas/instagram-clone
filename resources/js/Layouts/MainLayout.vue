...
<template>
	<div id="MainLayout" class="w-full h-screen">
			...
			<div class="flex items-center justify-between h-full">
				...
				<div class="flex items-center w-[50%]">
					<div class="flex items-center w-full bg-gray-100 rounded-lg">
						...
						<input type="text" placeholder="Search" class="bg-transparent w-full placeholder-[#8E8E8E] border-0 ring-0 focus:ring-0" />
					</div>
		...
		<div v-if="$page.url !== '/'" id="TopNavUser"
			class="md:hidden fixed flex items-center justify-between z-30 w-full bg-white h-[16px] border-b border-b-gray-300">
		...
		<div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[100px] overflow-auto">
			...
			<div v-if="$page.url === '/'" id="SuggestionSection" class="w-4/12 lg:block hidden text-black mt-10">
		...
		<div id="BottomNav" class="fixed z-30 bottom-0 w-full md:hidden flex items-center justify-around bg-white border-t py-2 border-t-gray-300">
			...
			<Link href="/">
			<img class="w-[30px] rounded-full cursor-pointer" src="https://picsum.photos/id/200/300/320" />
			</Link>
